...
class wsInputManager {
    ...
    public:
        ...
        void setMousePos(i32 posX, i32 posY) { mouse.setPos(posX, posY); }
        void pressMouseButton(u32 btnState) { mouse.pressButton(btnState); }
        void releaseMouseButton(u32 btnState) { mouse.releaseButton(btnState); }
};
